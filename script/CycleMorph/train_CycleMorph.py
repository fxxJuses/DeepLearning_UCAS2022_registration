...
#     train_npy_path = '/home/ma-user/work/train_npy.npy'
#     val_npy_path = '/home/ma-user/work/val_npy.npy'
    batch_size = 1
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        for data in train_loader:
            ...
            print('Iter {} of {} loss {:.8f}, Reg: {:.6f}'.format(idx, len(train_loader), loss_fed, loss_reg_all))
...
#         torch.save(model,'experiments/'+save_dir + '/' + 'dsc{:.3f}.pth'.format(eval_dsc.avg))
